...
fun AdminHomeScreen(
    ...
    onLogout: () -> Unit,
    onNavigateToSendNotifications: () -> Unit,
    ...
    Column(
        ...
        Card(
            ...
            Column(
                ...
                Button(
                    onClick = onNavigateToSendNotifications,
                    modifier = Modifier
                        .fillMaxWidth()
                ...
                // Otros botones para funciones de administrador...
                Button(
                    onClick = { /* Implementar gestión de usuarios */ },
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(vertical = 4.dp)
                ) {
        ...
        // Tarjeta para ver notificaciones
        Card(
            modifier = Modifier
                .fillMaxWidth()
                .padding(vertical = 8.dp)
            ...
            Column(
                ...
                OutlinedButton(
                    onClick = onNavigateToViewNotifications,
